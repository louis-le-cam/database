...
pub use crate::{
    ...
    expression::{
        ...
        ConditionExpression, DurationExpression, EqualExpression, Expression, ExpressionNode,
        Filter, FilterExpression, FromPath, FuseExpression, GetExpression, HashMapExpression,
        HashSetExpression, Int128Equal, Int16Equal, Int32Equal, Int64Equal, Int8Equal,
        MapVariantExpression, MapVec, OptionExpression, OptionMappedExpression, OptionOperators,
        PathExpression, Set, SetExpression, SlotMapExpression, StringEqual, TupleExpression1,
        ...
        Uint8Equal, VecExpression, VecGet,
    },
