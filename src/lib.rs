...
pub use crate::{
    ...
    expression::{
        ...
        ExpressionNode, FromPath, OptionExpression, Set, SetExpression, StringExpression,
        ...
        TupleExpression7, TupleExpression8, TupleExpression9, UnitExpression, VecExpression,
    },
