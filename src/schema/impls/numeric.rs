...
use crate::{
    ...
    Int16Expression, Int32Expression, Int64Expression, Int8Expression, Schema, Uint128Expression,
    Uint16Expression, Uint32Expression, Uint64Expression, Uint8Expression,
};
...
impl_numerics_non_zero! {
    NonZeroU8 write_u8 read_u8 UINT8 Uint8Expression;
    NonZeroU16 write_u16 read_u16 UINT16 Uint16Expression;
    NonZeroU32 write_u32 read_u32 UINT32 Uint32Expression;
    NonZeroU64 write_u64 read_u64 UINT64 Uint64Expression;
    NonZeroU128 write_u128 read_u128 UINT128 Uint128Expression;
    NonZeroI8 write_i8 read_i8 INT8 Int8Expression;
    NonZeroI16 write_i16 read_i16 INT16 Int16Expression;
    NonZeroI32 write_i32 read_i32 INT32 Int32Expression;
    NonZeroI64 write_i64 read_i64 INT64 Int64Expression;
    NonZeroI128 write_i128 read_i128 INT128 Int128Expression;
}
